...
function Main(props) {
    return (
        <main role="main">
            <Router>
                <Switch>
                    <Route path="/PrivacyAndLicenseAgreement" render={() => <PrivacyAndLicenseAgreement {...props} />} />
                    <Route path="/PrivacyAndLicenseAgreementFR" render={() => <PrivacyAndLicenseAgreementFR {...props} />} />
                    <Route path="/BCeIDLanding" component={BCeIDLanding} />
                    <Route path="/HomeFR" render={() => <HomeFR {...props} />} />
